...
ggplot2::ggplot(data = data) +
  ggplot2::geom_point(ggplot2::aes(x = Q, y = Y)) +
  ggplot2::theme_light()  +
  ggplot2::labs(title = 'Q-Y Relationship') +
  ggplot2::ggplot(data = data) +
  ggplot2::geom_point(ggplot2::aes(x = Q, y = TW)) +
  ggplot2::theme_light() +
  ggplot2::labs(title = 'Q-TW Relationship') +
  ggplot2::ggplot(data = data) +
  ggplot2::geom_point(ggplot2::aes(x = Q, y = V)) +
  ggplot2::theme_light()  +
  ggplot2::labs(title = 'Q-V Relationship')
```
...
```{r}
(sf = FHGestimation::fhg_estimate(df = select(data, Q, Y), allowance = .05))
```

```{r, echo = FALSE}
ggplot2::ggplot() +
  ggplot2::geom_point(data = data, ggplot2::aes(x = Q, y = Y), col = "black") +
  ggplot2::geom_line(data = data, ggplot2::aes(
    x = Q,
    y = sf$coef[1] * Q ^ (sf$exp[1]),
    col = "NLS"
  )) +
  ggplot2::geom_line(data = data, ggplot2::aes(
    x = Q,
    y = sf$coef[2] * Q ^ (sf$exp[2]),
    col = "OLS"
  )) +
  ggplot2::theme_light()  +
  ggplot2::theme(legend.position = "bottom") +
  ggplot2::labs(title = 'Q-Y Relationship', color = "Fit") +
  ggplot2::scale_color_manual(values = c("NLS" = "blue", "OLS" = "red"))
...
```{r}
(x = FHGestimation::fhg_estimate(data, allowance = .05))
```
...
ggplot2::ggplot() +
  ...
  ggplot2::theme_light() +
  ggplot2::labs(title = 'Q-TW Relationship', color = "Fit") +
  ggplot2::ggplot(data = data) +
  ggplot2::geom_point(data = data, ggplot2::aes(x = Q, y = V), col = "black") +
  ggplot2::geom_line(data = data, ggplot2::aes(
    x = Q,
    y = x$V_coef[1] * Q ^ (x$V_exp[1]),
    col = "bestValid"
  )) +
  ggplot2::theme_light()  +
  ggplot2::labs(title = 'Q-V Relationship', color = "Fit") +
...
ggplot2::ggplot() +
  ggplot2::geom_point(data = data, ggplot2::aes(x = Q, y = Y, col = "Full")) +
  ggplot2::geom_line(data = data, ggplot2::aes(
    x = Q,
    y = x$Y_coef[1] * Q ^ (x$Y_exp[1]),
    col = "Full"
  )) +
  ggplot2::geom_point(data = hf_data, ggplot2::aes(x = Q, y = Y, col = "Filter")) +
  ggplot2::geom_line(data = hf_data, ggplot2::aes(
    x = Q,
    y = xf$Y_coef[1] * Q ^ (xf$Y_exp[1]),
    col = "Filter"
  )) +
  ggplot2::theme_light()  +
  ggplot2::labs(title = 'Q-Y Relationship') +
  ggplot2::scale_color_manual(values = c("Filter" = "red", "Full" = "black")) +
  ggplot2::ggplot(data = data) +
  ggplot2::geom_point(data = data, ggplot2::aes(x = Q, y = Y, col = "Full")) +
  ggplot2::geom_line(data = data, ggplot2::aes(
    x = Q,
  ...
  ggplot2::geom_point(data =
                        data, ggplot2::aes(x = Q, y = V, col = "Full")) +
  ggplot2::geom_line(data = data, ggplot2::aes(
    x = Q,
    y = x$V_coef[1] * Q ^ (x$V_exp[1]),
    col = "Full"
  )) +
  ggplot2::geom_point(data = hf_data, ggplot2::aes(x = Q, y = V, col = "Filter")) +
  ggplot2::geom_line(data = hf_data, ggplot2::aes(
    x = Q,
    y = xf$V_coef[1] * Q ^ (xf$V_exp[1]),
    col = "Filter"
  )) +
  ggplot2::theme_light()  +
  ggplot2::labs(title = 'Q-V Relationship') +
...
ahg_fit = FHGestimation::fhg_estimate(filter_data)[1,]

(shape = FHGestimation::compute_hydraulic_params(ahg_fit))

cs = FHGestimation::cross_section(
  r = shape$r,
...
```{r, echo = FALSE}
ggplot2::ggplot(data = cs) +
  ggplot2::geom_point(ggplot2::aes(x = x, y = Y)) +
  ggplot2::geom_line(ggplot2::aes(x = x, y = Y)) +
  ggplot2::theme_light() +
  ggplot2::geom_hline(yintercept = max(cs$Y), color = "darkgreen") +
  ggplot2::geom_hline(yintercept = 2,
                      color = "blue",
                      linewidth = 2) +
  ggplot2::geom_vline(xintercept = mean(cs$x), color = "darkgreen") +
  ggplot2::labs(x = "Relative Width", y = "Depth", title = "Shape") +
  ggplot2::ggplot(data = cs) +
  ggplot2::geom_point(ggplot2::aes(x = A, y = Y)) +
  ggplot2::geom_line(ggplot2::aes(x = A, y = Y)) +
  ggplot2::geom_hline(yintercept = 2,
                      color = "blue",
                      linewidth = 2) +
  ggplot2::theme_light() +
  ggplot2::labs(Y = "Depth", x = "Cross Sectional Area", title = "Area to Depth") 
```
