...
mm = AHGestimation:::min_max(nwis, 1.5)
...
tt = readRDS(system.file("extdata/pop-gen-experiment.rds", package = "AHGestimation")) %>% 
  group_by(gen, pop) %>% 
...
```{r, echo = FALSE}
x = readRDS(system.file("extdata/prob-experiment.rds", package = "AHGestimation"))
...
```{r, echo = FALSE}
s = readRDS(system.file("extdata/seed-test-200.rds", package = "AHGestimation"))
