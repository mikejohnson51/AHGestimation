...
3. **Formalization of derived AHG Concepts** (`cross_section`, `compute_hydraulic_params`, `compute_n`): These functions formalize concepts from existing literature, such as the relationship between AHG coefficients and exponents and cross-section hydraulics and geometry. Formalize, in code, many of the concepts derived in [@dingman2018field] that relate AHG coefficients and exponents to cross-section hydraulics and geometry. 
